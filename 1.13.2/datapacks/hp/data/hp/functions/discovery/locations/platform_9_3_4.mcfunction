# On Discover
execute as @s[tag=!discovered_platform_9_3_4,scores={playerID=1},tag=!inProperCutScene] run bossbar set minecraft:player1empty name {"text":"발견","color":"white","italic":"true"}
execute as @s[tag=!discovered_platform_9_3_4,scores={playerID=2},tag=!inProperCutScene] run bossbar set minecraft:player2empty name {"text":"발견","color":"white","italic":"true"}
execute as @s[tag=!discovered_platform_9_3_4,scores={playerID=3},tag=!inProperCutScene] run bossbar set minecraft:player3empty name {"text":"발견","color":"white","italic":"true"}
execute as @s[tag=!discovered_platform_9_3_4,scores={playerID=4},tag=!inProperCutScene] run bossbar set minecraft:player4empty name {"text":"발견","color":"white","italic":"true"}
