# On Discover
execute as @s[tag=!discovered_road_to_hogwarts,scores={playerID=1},tag=!inProperCutScene] run bossbar set minecraft:player1empty name {"text":"발견","color":"white","italic":"true"}
execute as @s[tag=!discovered_road_to_hogwarts,scores={playerID=2},tag=!inProperCutScene] run bossbar set minecraft:player2empty name {"text":"발견","color":"white","italic":"true"}
execute as @s[tag=!discovered_road_to_hogwarts,scores={playerID=3},tag=!inProperCutScene] run bossbar set minecraft:player3empty name {"text":"발견","color":"white","italic":"true"}
execute as @s[tag=!discovered_road_to_hogwarts,scores={playerID=4},tag=!inProperCutScene] run bossbar set minecraft:player4empty name {"text":"발견","color":"white","italic":"true"}
execute at @s[tag=!discovered_road_to_hogwarts,tag=!inProperCutScene] run playsound minecraft:custom.ui.discovery.discover_location master @s ~ ~ ~ 10 1 1
...
scoreboard players set @s lastLocation 22