...
setblock 726 32 343 minecraft:wall_sign[facing=south]{Text1:"{\"text\":\"Брахиам Эмендо\",\"color\":\"black\"}",Text2:"{\"text\":\" \",\"color\":\"black\"}",Text3:"{\"text\":\"Лучшее время:\",\"color\":\"black\"}",Text4:"{\"score\":{\"name\":\"brackiumEmendoBestTimeM\",\"objective\":\"global\"},\"color\":\"black\",\"extra\":[{\"text\":\":\",\"color\":\"black\"},{\"score\":{\"name\":\"brackiumEmendoBestTimeS\",\"objective\":\"global\"},\"color\":\"black\"}]}"} destroy
