...
execute if entity @s[scores={fastTravelID=41}] run title @s subtitle {"text":"프리벳가","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=48}] run title @s subtitle {"text":"9와 3/4 승강장","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=52}] run title @s subtitle {"text":"올리밴더의 지방이 가게","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=71}] run title @s subtitle {"text":"후려치는 나무 비밀통로","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=75}] run title @s subtitle {"text":"그리몰드 가 12번지","bold":true,"color":"gold"}
