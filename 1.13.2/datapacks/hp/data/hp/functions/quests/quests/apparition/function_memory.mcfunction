...
execute as @s[tag=newState] run scoreboard players set @s selectedSpell 9
execute as @s[tag=newState] run scoreboard players set @s currentSpell 9
...
execute as @s[tag=newState] run tag @s add hasLearnedApparition
...
execute as @s[scores={questState=4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1556,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=5},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1462,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=7},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1461,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=8},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1555,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=11,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=11,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=11,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=11,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
...
execute as @s[scores={questState=11,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 1","color":"gold"}]	
execute as @s[scores={questState=11,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 1","color":"gold"}]
execute as @s[scores={questState=11,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 1","color":"gold"}]
execute as @s[scores={questState=11,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 1","color":"gold"}]
...
execute as @s[scores={questState=11,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=11,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=11,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=11,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
...
execute as @s[scores={questState=12,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=12,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=12,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=12,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=12,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=12,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=12,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=12,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 2","color":"gold"}]
...
execute as @s[scores={questState=12,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=12,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=12,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=12,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
...
execute as @s[scores={questState=13,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=13,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=13,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=13,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=13,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=13,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=13,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=13,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 3","color":"gold"}]
...
execute as @e[tag=creature,scores={waveID=4,questID=22}] run scoreboard players remove @p[tag=activePlayer] tmp 1
execute as @s[scores={questState=13,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
execute as @s[scores={questState=13,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
execute as @s[scores={questState=13,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
execute as @s[scores={questState=13,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
