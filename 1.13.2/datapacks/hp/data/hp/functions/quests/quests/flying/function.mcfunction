...
# Flying
##############################################
scoreboard players set @s questID 30
execute store result score @s questState run data get entity @e[tag=questHolder,limit=1] ArmorItems[3].tag."quests.flying"
...
execute as @s[scores={questState=1,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"표시된 곳으로 가서 빗자루에 타세요","color":"gold"}]
execute as @s[scores={questState=1,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"표시된 곳으로 가서 빗자루에 타세요","color":"gold"}]
execute as @s[scores={questState=1,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"표시된 곳으로 가서 빗자루에 타세요","color":"gold"}]
execute as @s[scores={questState=1,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"표시된 곳으로 가서 빗자루에 타세요","color":"gold"}]



# Trigger
execute positioned 668.57 53.00 9.76 as @s[tag=flyingBroom,scores={questState=1},tag=!inConversation,tag=isTrackedQuest,distance=..2] run tag @s add newState
...
execute as @s[scores={questState=13..99},tag=isTrackedQuest] run function hp:quests/quests/flying/timer
...
execute as @s[tag=newState] if score @s tmp < timer flyingHighscore run scoreboard players operation timer lyingHighscore = @s tmp
...
execute as @s[scores={questState=100},tag=isTrackedQuest] run function hp:quests/quests/flying/timer
...
execute as @s[scores={questState=100,playerID=2},tag=isTrackedQuest] if score flyingTimer p2Quests matches 0.. run tag @s add completeQuest
execute as @s[scores={questState=100,playerID=3},tag=isTrackedQuest] if score flyingTimer p3Quests matches 0.. run tag @s add completeQuest
execute as @s[scores={questState=100,playerID=4},tag=isTrackedQuest] if score flyingTimer p4Quests matches 0.. run tag @s add completeQuest


####################################
# Cancel if player steps off broom #
####################################
execute as @s[scores={questState=3..99},tag=!flyingBroom] run tag @s add newState
execute as @s[tag=newState,scores={playerID=1}] run scoreboard players set flyingTimer p1Quests -4000
execute as @s[tag=newState,scores={playerID=2}] run scoreboard players set flyingTimer p2Quests -4000
execute as @s[tag=newState,scores={playerID=3}] run scoreboard players set flyingTimer p3Quests -4000
execute as @s[tag=newState,scores={playerID=4}] run scoreboard players set flyingTimer p4Quests -4000
execute as @s[tag=newState] run scoreboard players set @s questState 101
execute as @s[tag=newState] at @s run playsound minecraft:custom.ui.error master @s
execute as @s[tag=newState] run function hp:quests/set_quest
execute as @s[tag=newState] run tag @s remove newState
...
execute as @s[scores={questState=101,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"기록이 취소되었습니다.","color":"red"}]
execute as @s[scores={questState=101,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"기록이 취소되었습니다.","color":"red"}]
execute as @s[scores={questState=101,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"기록이 취소되었습니다.","color":"red"}]
execute as @s[scores={questState=101,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"기록이 취소되었습니다.","color":"red"}]

### Trigger ###
execute as @s[scores={questState=101,playerID=1}] if score flyingTimer p1Quests matches 0.. run tag @s add completeQuest
execute as @s[scores={questState=101,playerID=2}] if score flyingTimer p2Quests matches 0.. run tag @s add completeQuest
execute as @s[scores={questState=101,playerID=3}] if score flyingTimer p3Quests matches 0.. run tag @s add completeQuest
execute as @s[scores={questState=101,playerID=4}] if score flyingTimer p4Quests matches 0.. run tag @s add completeQuest
