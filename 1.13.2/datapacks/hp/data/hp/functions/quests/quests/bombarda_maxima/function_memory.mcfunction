...
execute as @s[tag=newState] run scoreboard players set @s selectedSpell 6
execute as @s[tag=newState] run scoreboard players set @s currentSpell 6
execute as @s[tag=newState] run tag @s remove hasLearnedBombardaMaxima
