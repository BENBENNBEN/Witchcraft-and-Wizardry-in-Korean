...
execute store result score @s falling run data get entity 0-0-13-0-4 FallDistance 10
...
# Scroll testers
execute as 0-0-13-0-4 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectUp],UUID:[I;0,20,0,13]}
execute as 0-0-13-0-4 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectDown],UUID:[I;0,20,0,14]}
execute as 0-0-13-0-4 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectLeft],UUID:[I;0,20,0,15]}
execute as 0-0-13-0-4 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectRight],UUID:[I;0,20,0,16]}
...
execute unless score @s convState matches 1..2 at 0-0-13-0-4 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:settings/settings_scroll_down
...
execute if score @s convState matches 1 at 0-0-13-0-4 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:settings/settings_credits_scroll_down
...
execute unless score @s convState matches 1..2 at 0-0-13-0-4 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:settings/settings_scroll_up
...
execute if score @s convState matches 1 at 0-0-13-0-4 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:settings/settings_credits_scroll_up
...
execute store result score @s tmp run data get entity 0-0-13-0-4 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-13-0-4 Rotation[1] 1000
...
execute at 0-0-13-0-4 as @s[distance=0.001..,tag=!softExitMap] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!delaySettingsOneTick] run tp @s 0-0-13-0-4
...
execute as @s[tag=adjustGUI,scores={playerID=1}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player1info name {"text":"설정","bold":true,"color":"gray"}
execute as @s[tag=adjustGUI,scores={playerID=2}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player2info name {"text":"설정","bold":true,"color":"gray"}
execute as @s[tag=adjustGUI,scores={playerID=3}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player3info name {"text":"설정","bold":true,"color":"gray"}
execute as @s[tag=adjustGUI,scores={playerID=4}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player4info name {"text":"설정","bold":true,"color":"gray"}
