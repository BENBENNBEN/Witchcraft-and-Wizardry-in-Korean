...
execute as @s[tag=adjustGUI,scores={playerID=1}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player1info name {"text":"Настройки","bold":true,"color":"gray"}
execute as @s[tag=adjustGUI,scores={playerID=2}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player2info name {"text":"Настройки","bold":true,"color":"gray"}
execute as @s[tag=adjustGUI,scores={playerID=3}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player3info name {"text":"Настройки","bold":true,"color":"gray"}
execute as @s[tag=adjustGUI,scores={playerID=4}] unless entity @s[scores={convState=2,selectCurrent=3}] run bossbar set minecraft:player4info name {"text":"Настройки","bold":true,"color":"gray"}
