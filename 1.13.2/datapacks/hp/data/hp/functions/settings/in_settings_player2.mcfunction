...
execute unless score @s convState matches 1..2 at 0-0-13-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:settings/settings_scroll_down
...
execute if score @s convState matches 1 at 0-0-13-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:settings/settings_credits_scroll_down
...
execute unless score @s convState matches 1..2 at 0-0-13-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:settings/settings_scroll_up
...
execute if score @s convState matches 1 at 0-0-13-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:settings/settings_credits_scroll_up
...
execute store result score @s tmp run data get entity 0-0-13-0-2 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-13-0-2 Rotation[1] 1000
...
execute at 0-0-13-0-2 as @s[distance=0.001..,tag=!softExitMap] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!delaySettingsOneTick] run tp @s 0-0-13-0-2
