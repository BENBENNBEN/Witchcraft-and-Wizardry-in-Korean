...
# Scroll testers
execute as 0-0-13-0-1 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectUp],UUID:[I;0,20,0,1]}
execute as 0-0-13-0-1 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectDown],UUID:[I;0,20,0,2]}
execute as 0-0-13-0-1 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectLeft],UUID:[I;0,20,0,3]}
execute as 0-0-13-0-1 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectRight],UUID:[I;0,20,0,4]}
