...
execute store result score @s falling run data get entity 0-0-13-0-3 FallDistance 10
...
# Scroll testers
execute as 0-0-13-0-3 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectUp],UUID:[I;0,20,0,9]}
execute as 0-0-13-0-3 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectDown],UUID:[I;0,20,0,10]}
execute as 0-0-13-0-3 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectLeft],UUID:[I;0,20,0,11]}
execute as 0-0-13-0-3 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"settingsDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[settingsSelect,selectRight],UUID:[I;0,20,0,12]}
...
execute unless score @s convState matches 1..2 at 0-0-13-0-3 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:settings/settings_scroll_down
...
execute if score @s convState matches 1 at 0-0-13-0-3 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:settings/settings_credits_scroll_down
...
execute unless score @s convState matches 1..2 at 0-0-13-0-3 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:settings/settings_scroll_up
...
execute if score @s convState matches 1 at 0-0-13-0-3 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=settingsSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:settings/settings_credits_scroll_up
...
execute store result score @s tmp run data get entity 0-0-13-0-3 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-13-0-3 Rotation[1] 1000
...
execute at 0-0-13-0-3 as @s[distance=0.001..,tag=!softExitMap] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!delaySettingsOneTick] run tp @s 0-0-13-0-3
