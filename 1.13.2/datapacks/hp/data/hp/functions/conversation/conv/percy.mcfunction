...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=7}] run data merge entity @s {CustomName:"{\"text\":\"다른 거 때문인데.\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
