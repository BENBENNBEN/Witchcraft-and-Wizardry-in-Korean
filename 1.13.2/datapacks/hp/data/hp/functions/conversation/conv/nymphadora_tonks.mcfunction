...
execute as @s[scores={delayConvTellraw=2,playerID=1}] run scoreboard players operation @s convState = nymphadoraTonks p1convOverride
execute as @s[scores={delayConvTellraw=2,playerID=2}] run scoreboard players operation @s convState = nymphadoraTonks p2convOverride
execute as @s[scores={delayConvTellraw=2,playerID=3}] run scoreboard players operation @s convState = nymphadoraTonks p3convOverride
execute as @s[scores={delayConvTellraw=2,playerID=4}] run scoreboard players operation @s convState = nymphadoraTonks p4convOverride
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 어이, 어린 친구! \\n\"}"}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≤ 불사조 기사단에 대해 얘기해주세요 \"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------

execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤ 왜 머리가 보라색이세요? \"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ 어디 기숙사 소속이셨나요? \"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 덤블도어 교수님이 그 사람과 추종자들에 대항하기 위해 만든 비밀 결사단이야. 마법사 전쟁 때 아주 많이 활약했었지. 난 마법 정부에서 매드아이 무디에게 훈련을 받으며 오러로 일하고 있어. 최근에 불사조 기사단도 합류했지. 아직 해야 할 일이 있는 것 같아. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 아, 특이하지? 내가 메타모르프마구스라서 그래. 선천적으로 내 얼굴을 자유자재로 바꿀 수 있거든. 따로 훈련을 받지 않아도 항상 변장 부분에서는 높은 점수를 받았지. 머리색은... 내가 보라색을 좋아해. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 난 후플푸프였는데 나쁘지 않았어. 기숙사 사감 선생님께서 항상 덤벙거린다고 잔소리하셨지만. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
