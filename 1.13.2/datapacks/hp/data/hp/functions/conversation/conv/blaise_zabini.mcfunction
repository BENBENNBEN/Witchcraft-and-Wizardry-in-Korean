...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 이게 뭔데? 아. 보긴 앤 버크에서 주문한 소포구나. 기다리고 있었어. \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 그래, 내 소포를 배달해줘서 고마워. \\n 여기, 이거 받아. 75 ≈ \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
