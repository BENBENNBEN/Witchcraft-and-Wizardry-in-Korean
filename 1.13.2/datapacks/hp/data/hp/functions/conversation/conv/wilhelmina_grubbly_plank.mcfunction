...
execute as @s[scores={delayConvTellraw=2,playerID=1}] run scoreboard players operation @s convState = wilhelminaGrubblyPlank p1convOverride
execute as @s[scores={delayConvTellraw=2,playerID=2}] run scoreboard players operation @s convState = wilhelminaGrubblyPlank p2convOverride
execute as @s[scores={delayConvTellraw=2,playerID=3}] run scoreboard players operation @s convState = wilhelminaGrubblyPlank p3convOverride
execute as @s[scores={delayConvTellraw=2,playerID=4}] run scoreboard players operation @s convState = wilhelminaGrubblyPlank p4convOverride
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 어서 오렴, 얘야. 호그스미드 지점, 마법 동물원에 온 걸 환영해. 얼마든지 구경하렴.\"}"}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 물어보고 싶은 게 뭐니?\\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≤ 니플러에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤ 문카프에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ 머트랩에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=4}] run data merge entity @s {CustomName:"{\"text\":\"≤ 보우트러클에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=5}] run data merge entity @s {CustomName:"{\"text\":\"≤ 피그미 퍼프에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=6}] run data merge entity @s {CustomName:"{\"text\":\"≤ 데미가이즈에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=7}] run data merge entity @s {CustomName:"{\"text\":\"≤ 두꺼비에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=8}] run data merge entity @s {CustomName:"{\"text\":\"≤ 부엉이에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=9}] run data merge entity @s {CustomName:"{\"text\":\"≤ 고양이에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=10}] run data merge entity @s {CustomName:"{\"text\":\"≤ 토끼에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=11}] run data merge entity @s {CustomName:"{\"text\":\"≤ 쥐에 대해 설명해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=12}] run data merge entity @s {CustomName:"{\"text\":\"≥ 안녕히 계세요\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 문카프는 수줍음이 많아서 보름달이 뜰 때만 나와. 짝짓기 때는 뒷발을 이용해서 복잡하고 정교한 구애의 춤을 춰. 짝짓기 때 문카프들이 밀밭에 남긴 기하학적인 무늬들은 머글들에게 풀리지 않는 미스터리야. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 피그미 퍼프는 퍼프스캔의 신종 생물이야. 마치 굴러다니는 솜털 공처럼 생겼고, 분홍색이나 보라색이야. 어린 마녀나 마법사들에게 인기가 많지. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 두꺼비는 마법 생물이 아니야. 머글도 마법사도 잘 알고 있는 동물이지만, 마법 세계에서는 반려동물로 인기가 많아. 호그와트 학생들에게 허용되는 동물 중 하나야. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 부엉이는 마법 생물이 아니야. 머글도 마법사도 잘 아는 동물이지. 마법 친화력이 전혀 없는 돼지랑은 다르게 부엉이는 마법 친화력이 있어. 어느 정도 소통도 가능해서 마법 세계에서 유용해. 편지나 소포, 하울러를 배달해주니까. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 고양이는 마녀와 마법사들이 반려동물로 많이 길러. 호그와트에 데려갈 수도 있고. 고양이와 니즐은 교배가 가능하고 몇몇 마법사와 마녀는 순종 니즐이나 혼혈 니즐과 교배시켜서 분양하는 걸로 돈을 벌기도 해. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 토끼는 종종 머글이 상상하는 마법에 등장해. 갑자기 모자에서 나타난 토끼라든가. 그치만 마법 생물은 아니야. 그래도 마녀와 마법사들 사이에서 인기 있어. 많은 마녀와 마법사들의 패트로누스이기도 하고. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 쥐는 마법사와 마녀의 반려 동물이야. 몇 년밖에 못 살아서 부엉이나 고양이만큼 인기는 없지만, 쥐꼬리는 물약 만들 때 유용해. 야생 쥐는 다소 공격적일 수도 있으니까 조심해야 해. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 내가 아픈 문카프를 돌보고 있거든. 빨리 낫도록 지켜보느라 곁을 떠나고 싶지 않아. 그래서 말인데, 혹시 도와줄 수 있니? \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 해그리드 오두막에 가서 조언을 구하고 내게 전해줘. \"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ 알겠어요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] unless entity @p[tag=queingQuest] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run scoreboard players set curableCreatureConsultation sharedQuests 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] unless entity @p[tag=queingQuest] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run scoreboard players set curableCreatureConsultation p1Quests 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] unless entity @p[tag=queingQuest] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run scoreboard players set curableCreatureConsultation p2Quests 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] unless entity @p[tag=queingQuest] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run scoreboard players set curableCreatureConsultation p3Quests 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] unless entity @p[tag=queingQuest] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run scoreboard players set curableCreatureConsultation p4Quests 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] unless entity @p[tag=queingQuest] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run scoreboard players set @a[tag=play] questQueueID 55
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ 아뇨 관심 없어요\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
#-------------------------------
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 그래 다행이다. 나도 그렇다고 생각했는데 다른 의견을 듣는 건 항상 중요하니까. 해그리드가 마법 생물에 대해서는 해박하거든. \\n 여기, 이거 받아, 고마움의 표시야. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"감사합니다 (수락: 75 ≈)\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] run tag @s add hasCompletedCurableCreatureConsultation
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
#-------------------------------
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 아! 고맙습니다 \\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
