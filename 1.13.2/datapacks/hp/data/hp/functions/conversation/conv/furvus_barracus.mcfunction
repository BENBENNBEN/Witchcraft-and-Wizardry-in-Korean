...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 흠? 살 거 아니라면 책을 찢거나 망가뜨리지 말거라!\\n\\n\\n\",\"color\":\"white\",\"bold\":\"false\"}"}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 아 그래. 옵스큐러스 서점에 온 걸 환영해. 다이애건 앨리와 호그스미드에 있지.\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 여긴 서점이자 출판사야. 네가 보면 알겠지만. \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 다이애건 앨리에는 여러 서점이 있지. 계속 질문하면서 귀찮게 할 거면, 다른 서점에 가봐.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 뭐를 말이냐? 이 서점은 다이애건 앨리에서 잘 돼서 다른 서점도 열었어. 거기를 운영하는 동료와 부엉이로 대화했는데 이 쓸모없는 새가 지금 너무 힘들어서 못 간대. 생각해보니까 네가 도움이 될지도 모르겠군.\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 이 편지를 호그스미드에 있는 내 동료에게 가져다 줄래? 그가 너한테 감사의 표시를 해줄 거다.\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"ⁿ 제가 편지 배달할게요 (보상: 50 ≈)\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
####
# Add quest
#####
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ 죄송하지만 관심 없어요\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
