...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 엘릭의 엘릭서에 어서 옵쇼! 괜히 가마솥 앞에서 땀 흘리지 마시고 저희 가게 선반에 진열돼있는 물약을 사세요. 품질 만족 보장해드립니다. 무료 샘플 같은 건 없지만요.\\n\\n\"}"}
...
##### Conversation Header ######
################################
execute if score elikElixersRats sharedQuests matches 0 if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 빌어먹을 쥐들이 재료를 먹어치우는 바람에 재고가 많지는 않아요. 그래도 찾으시는 게 있으면 좋겠습니다.\"}"}
...
execute if score elikElixersRats sharedQuests matches -1 if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 쥐들을 제거하는 데 도와주셔서 감사합니다! 어떻게 도와드릴까요?\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 직접 물약 제조하시려면 재료는 여러 방법으로 조달하실 수 있습니다. 재료를 돈으로 사실 거라면, 재료를 파는 상점에 가보세요.\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 하지만 무료로 재료를 구하시려면, 직접 돌아다니면서 구하셔야 합니다. 좋은 재료가 어디 땅에 떨어져 있을지도 모르니까요. 몬스터나 공격적인 생물을 사냥하는 것도 재료를 얻을 수 있는 방법이고요.\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 저도 당신처럼 호그와트 다닐 적에 배웠습니다. 저때는 호러스 슬러그혼 교수님이었죠. 마법약 과목은 재밌었는데, 교수님이 별로 였습니다. 편애하는 애들은 모아둔 '슬러그 클럽'이란 게 있었는데, 한 번도 초대된 적이 없어요. 제 혈통이 문제였나 봅니다. 전 머글 태생이거든요. 진짜 슬리데린 같으니라고!\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 다이애건 앨리는 물약 제조 장비나 재료를 파는 상점들로 가득합니다. 하지만 이미 제조된 물약이 필요하시면 이 구역에서 저만 찾으십쇼. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 아, 네. 저주받을 것들이 지하실을 통해 올라와 재료들을 먹어치웁니다. 내려가서 처리하려고 했지만, 제가 영 소질이 없어서요. 지팡이보다 가마솥이랑 더 친합니다.\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"ⁿ 제가 쥐를 없애는 걸 도와드릴 게요.\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 정말요? 그러면 정말 감사합니다. 다 처리해주시면 보상해드립죠.\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ 제가 따로 해야 할 일이 있습니다\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 2
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\" 고마워요 (수락: 150 ≈) \"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
