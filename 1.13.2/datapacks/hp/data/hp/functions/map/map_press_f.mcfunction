...
execute as @s[tag=!softExitMap,tag=!invInspectItem,tag=!preventDoubleExecution,tag=selectedDestinationLocked,scores={convState=1..}] run title @s subtitle {"text":"목적지를 잠금 해제하지 않았습니다!","bold":false,"color":"red"}
# Start state
