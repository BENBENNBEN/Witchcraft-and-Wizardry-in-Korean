...
execute as @s[scores={cutSceneTimer=21..95}] run tp @s 2860.32 66.34 732.19 -47.26 27.5
...
execute as @s[scores={cutSceneTimer=85}] run title @s subtitle ["",{"text":"고드릭 골짜기","bold":true,"color":"gold"}]
