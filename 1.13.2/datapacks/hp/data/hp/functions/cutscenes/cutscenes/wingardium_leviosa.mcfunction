...
execute as @s[scores={cutSceneTimer=861..950}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 마우스 휠을 사용하여 거리를 조정할 수 있어."}]
...
execute as @s[scores={cutSceneTimer=1351..1420}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 행운을 빌어!"}]
