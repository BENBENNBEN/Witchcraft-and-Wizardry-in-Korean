...
# Common room
##############################################
scoreboard players set @s questID 10
execute store result score @s questState run data get entity @e[tag=questHolder,limit=1] ArmorItems[3].tag."quests.talkToRavenclawPrefect"
...
execute as @s[tag=isTrackedQuest,tag=completeTrackedQuest] run tp @s 784.34 128.00 156.81 -226.76 -0.90
execute as @s[tag=isTrackedQuest,tag=completeTrackedQuest] run tag @s remove completeTrackedQuest

#############
## State 1 ###########################################################################################
#############
# Speak to Ravenclaw prefect

### Tracked Quest ###
execute as @s[scores={questState=1},tag=isTrackedQuest] run tag @s remove hideQuestTracking
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1547,Unbreakable:1b,qDetect:1b}
execute as @s[scores={questState=1},tag=isTrackedQuest] run tag @s remove questHasNoDirection
execute as @s[scores={questState=1},tag=isTrackedQuest] at @s as @e[tag=questDirectionTester,limit=1] positioned ~ ~ ~ run tp @s ~ ~ ~ facing 4968.46 31.00 1018.50
execute as @s[scores={questState=1,npcQuestIcon=1},tag=!inProperCutScene,tag=!inResetPoint,tag=!isFastTravelling] at @e[tag=ravenclawPrefect,limit=1] run particle minecraft:angry_villager ~ ~2 ~ 0 0 0 100 1 force @s
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1548,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1546,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=completeQuest,scores={playerID=1}] run scoreboard players set ravenclawPrefect p1convOverride 9
execute as @s[tag=completeQuest,scores={playerID=2}] run scoreboard players set ravenclawPrefect p2convOverride 9
execute as @s[tag=completeQuest,scores={playerID=3}] run scoreboard players set ravenclawPrefect p3convOverride 9
execute as @s[tag=completeQuest,scores={playerID=4}] run scoreboard players set ravenclawPrefect p4convOverride 9
execute as @s[tag=completeQuest,scores={playerID=1}] run scoreboard players set slytherinPrefect p1convOverride 8
execute as @s[tag=completeQuest,scores={playerID=2}] run scoreboard players set slytherinPrefect p2convOverride 8
execute as @s[tag=completeQuest,scores={playerID=3}] run scoreboard players set slytherinPrefect p3convOverride 8
execute as @s[tag=completeQuest,scores={playerID=4}] run scoreboard players set slytherinPrefect p4convOverride 8
