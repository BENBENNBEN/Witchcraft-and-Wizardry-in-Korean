...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=5}] run data merge entity @s {CustomName:"{\"text\":\"≤ 최근에 들은 소문 없으세요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
