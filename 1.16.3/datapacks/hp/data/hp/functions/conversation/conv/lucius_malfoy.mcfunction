...
execute as @s[scores={delayConvTellraw=2,playerID=1}] run scoreboard players operation @s convState = luciusMalfoy p1convOverride
execute as @s[scores={delayConvTellraw=2,playerID=2}] run scoreboard players operation @s convState = luciusMalfoy p2convOverride
execute as @s[scores={delayConvTellraw=2,playerID=3}] run scoreboard players operation @s convState = luciusMalfoy p3convOverride
execute as @s[scores={delayConvTellraw=2,playerID=4}] run scoreboard players operation @s convState = luciusMalfoy p4convOverride
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≤ 말포이 저택에 대해 얘기해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤ 말포이 가문에 대해 얘기해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ 호그와트에 대해 어떻게 생각하세요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=4}] run data merge entity @s {CustomName:"{\"text\":\"≤ 덤블도어에 대해 어떻게 생각하세요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=5}] run data merge entity @s {CustomName:"{\"text\":\"≤ 위즐리에 대해 어떻게 생각하세요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=6}] run data merge entity @s {CustomName:"{\"text\":\"≤ 해리 포터에 대해 어떻게 생각하세요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 말포이 가문은 마법 세계에서 존경받는 가문 중 하나이지. 신성한 28 가문 중 하나이며, 영국에 얼마 남지 않은 순수혈통 가문이야. 더할 나위 없이 순수하고 더럽히지 않은 것을 자랑스럽게 생각해. 다른 순수혈통 가문인 그린그래스, 로시에르, 블랙, 레스트레인지 가문과 좋은 관계를 유지하고 있어. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 위즐리? 어디 보자. 빨간 머리... 멍청해 보이는 얼굴... 물려 입은 옷과 책. 순수혈통 마법사 가문에게 맞게 품위 유지도 못 하는 불명예스러운 가족 정도. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 글쎄, 해리 포터를 싫어하는 내색을 보이는 건... 현명하지 않지. 지금은 사람들이 그를 어둠의 마왕을 물리친 대단한 영웅으로 여기니까. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
