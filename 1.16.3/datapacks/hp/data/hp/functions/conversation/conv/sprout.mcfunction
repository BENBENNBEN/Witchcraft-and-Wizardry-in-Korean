...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" 반가워! 약초학 수업에 온 걸 환영한단다. \"},{\"text\":\"난 포모나 스프라우트야\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\".\\n\\n\\n\\n\\n\",\"color\":\"white\",\"bold\":\"false\"}]"}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 어떻게 도와줄까, 얘야?\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≤ 약초학에 대해 얘기해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤ 후플푸프에 대해 얘기해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ 교수님도 호그와트를 다니셨나요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 온실에서 별 4개를 모으고 오렴. 방금 배운 맨드레이크의 특징을 잊지 말고. 근처에 보이거든 귀마개를 착용해. 그렇지 않으면 지나가지 못할 테니까.\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 곧 시작할 거란다. 모두 올 때까지 기다리렴.\\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 후플푸프는 헬가 후플푸프에 의해 설립되었어. 4개의 기숙사 중 가장 포용적이야. 특별한 능력보다는 성실함, 헌신, 인내심, 공정함을 중시하지. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 상징 동물은 오소리이고, 노란색과 검은색이 상징색이야. 내가 기숙사 사감이고, 뚱보 수도사가 기숙사 유령이야. 후플푸프에 약초학에 뛰어난 재능을 보이는 학생들이 많은데, 기숙사 환경이 식물로 둘러싸여 있어서 그런가 봐. 내 영향도 어느 정도 있겠지만. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 그럼. 후플푸프 학생이었단다. 호그와트 다닐 때 약초학에 재능을 싹을 틔웠고, 허버트 비어리 교수님이 은퇴하시고 그 자리를 대신하였지. 그리고 후플푸프 사감도 맡게 되었단다. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
