...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=4}] run data merge entity @s {CustomName:"{\"text\":\"다른 문지기는 출구가 어디라고 할까요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
