...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" 반갑다! 난 너희에게 비행을 가르칠 \"},{\"text\":\"롤랜다 후치 부인이라고 해.\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\".\\n\\n\\n\\n\\n\",\"color\":\"white\",\"bold\":\"false\"}]"}
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"ⁿ 한 바퀴 날고 싶어요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤ 가장 빠른 기록이 뭐였죠?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ 퀴디치에 대해 질문이 있어요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 그러렴. 표시된 원의 빗자루에 올라타면 기록을 시작할게! \"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≥ 최선을 다할게요!\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
# Conversation
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"아니 됐어요\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" 음? 어서, 시작해! 원으로 표시된 빗자루에 올라타면 기록을 시작할게! \\n\\n\\n\\n\"}]"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" 그래.\\n\\n\\n\\n\\n\"}]"}
execute if entity @s[tag=use] run scoreboard players set @s questTextTimer 3
execute as @s[scores={playerID=1},tag=use] run bossbar set minecraft:player1quest name ["",{"text":"가장 빠른 기록은 ","color":"gold"},{"score":{"name":"분","objective":"flyingHighscore"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"초야","objective":"flyingHighscore"},"color":"gold"},{"text":".","color":"gold"}]
execute as @s[scores={playerID=3},tag=use] run bossbar set minecraft:player3quest name ["",{"text":"가장 빠른 기록은: ","color":"gold"},{"score":{"name":"분","objective":"flyingHighscore"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"초야","objective":"flyingHighscore"},"color":"gold"},{"text":".","color":"gold"}]
execute as @s[scores={playerID=2},tag=use] run bossbar set minecraft:player2quest name ["",{"text":"가장 빠른 기록은: ","color":"gold"},{"score":{"name":"분","objective":"flyingHighscore"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"초야","objective":"flyingHighscore"},"color":"gold"},{"text":".","color":"gold"}]
execute as @s[scores={playerID=4},tag=use] run bossbar set minecraft:player4quest name ["",{"text":"가장 빠른 기록은: ","color":"gold"},{"score":{"name":"분","objective":"flyingHighscore"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"초야","objective":"flyingHighscore"},"color":"gold"},{"text":".","color":"gold"}]
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 퀴디치에 대해 알고 싶은 게 뭐니?\\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"퀴디치의 규칙이 뭐예요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"퀴디치는 언제 시작되었나요?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"퀴디치 경기장에 대해 말해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" 퀴디치는 다른 빗자루 게임에서 많은 영향을 받았어. 퀴디치라는 이름은 첫 게임이 있었던 퀴디치 습지에서 비롯되었지. 1050년경 습지 가장자리에 살았던 거티 케들이라는 마녀의 일기장에 기록되어 있었단다.\\n\"}]"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 호그와트에는 여러 퀴디치 팀이 연습하고 경기할 수 있는 퀴디치 경기장이 있단다. 매년 총 6번의 기숙사 팀 경기와 여러 연습 경기를 볼 수 있지.\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 첫 비행 수업에 온 걸 환영한다. 학교 빗자루를 잡고 서보렴. 빠른 빗자루는 아니지만, 지금은 충분할 거다. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 음? 뭘 기다리는 거니? 표시된 곳으로 가서 시작하렴. \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"표시된 지점에서 빗자루에 올라타고 시작해. \\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"얼른! 빛나는 고리를 통과해봐! \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 나쁘지 않았어! 이제 학교 빗자루는 다시 반납하고, 원한다면 다이애건 앨리에서 네 빗자루를 사도록 하렴. 언제든지 와서 네 최고 기록에 도전해봐.\\n\\n 다음 수업은 플리트윅 교수님이 가르치실 거란다. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 괜찮은 비행 실력이구나! 이제 학교 빗자루는 다시 반납하고, 원한다면 다이애건 앨리에서 네 빗자루를 사도록 하렴. 언제든지 와서 네 최고 기록에 도전해봐.\\n\\n 다음 수업은 플리트윅 교수님이 가르치실 거란다. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 아주 훌륭해! 이제 학교 빗자루는 다시 반납하고, 원한다면 다이애건 앨리에서 네 빗자루를 사도록 하렴. 언제든지 와서 네 최고 기록에 도전해봐.\\n\\n 다음 수업은 플리트윅 교수님이 가르치실 거란다. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 빗자루를 먼저 구매하렴. 다이애건 앨리에서 살 수 있을 거다. \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
