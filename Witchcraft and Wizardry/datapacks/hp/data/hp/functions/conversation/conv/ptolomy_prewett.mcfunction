...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 환영합니다. 다이애건 앨리에서 가장 다양한 물품을 파는 일반 상점입니다. 무엇을 도와드릴까요? \"}"}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≈ 팔고 싶은 물품이 있어요\"}",Tags:["_____sell_____","_____Normal_____","_____click_____","convOption","i"]}
