...
execute as @s[scores={delayConvTellraw=2,playerID=1}] run scoreboard players operation @s convState = flourish_blotts p1convOverride
execute as @s[scores={delayConvTellraw=2,playerID=2}] run scoreboard players operation @s convState = flourish_blotts p2convOverride
execute as @s[scores={delayConvTellraw=2,playerID=3}] run scoreboard players operation @s convState = flourish_blotts p3convOverride
execute as @s[scores={delayConvTellraw=2,playerID=4}] run scoreboard players operation @s convState = flourish_blotts p4convOverride
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 플러리시 앤 블러츠 서점에 오신 걸 환영합니다.\\n\\n\\n\\n\\n\"}"}
...
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0,playerID=1}] run scoreboard players set flourish_blotts p1convOverride 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0,playerID=2}] run scoreboard players set flourish_blotts p2convOverride 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0,playerID=3}] run scoreboard players set flourish_blotts p3convOverride 1
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0,playerID=4}] run scoreboard players set flourish_blotts p4convOverride 1
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 어떻게 도와드릴까요? \\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≤ 이 서점에 대해 얘기해주세요\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 플러리시 앤 블러츠 서점에 오신 걸 환영합니다. 어떻게 도와드릴까요?\\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ 학교 교과서를 사야 해요\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≡ 호그와트 교과서를 사기\"}",Tags:["_____buy_____","_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 어떤 책에 대해 더 알고 싶나요?\\n \"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=7}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 2
#-------------------------------
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 신비한 동물 사전은 뉴트 스캐맨더가 쓴 책으로 마법 생물들과 돌보는 법에 대해 자세히 설명했어요. 책이 쓰인 1927년부터 쭉 호그와트의 교과서였죠.\\n\\n \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 마법 주문에 관한 표준 교과서는 미란다 고스호크가 쓴 책이고, 호그와트에서는 여러 과목의 교과서로 사용하고 있죠. 총 7권으로 매 학년 배워야 할 주문들이 적혀 있어요.\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 마법과 마법의 약은 아르세니우스 지거가 쓴 책이랍니다. 호그와트에서는 어둠의 마법 방어법 수업의 교과서로 사용하고 있죠. 1학년 학생들의 필수 교과서예요.\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 어둠의 힘: 자기 방어를 위한 안내서는 퀜틴 트림블 교수가 쓴 교과서예요. 이 책에서는 다양한 어둠의 생물에 대해 적혀있죠. 그리고 밀치는 주문처럼 여러 방어 주문을 다루고 있어요.\\n\\n \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 입문자를 위한 변환 마법은 에머릭 스위치가 쓴 변환 마법 교과서입니다. 어린 마녀와 마법사를 위한 변환 마법 주문이 적혀있죠.\\n\\n \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 또 오세요! \\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
