...
execute as @s[scores={cutSceneTimer=200..320}] run title @s actionbar ["",{"text":""},{"text":"맥고나걸","color":"dark_gray"},{"text":" 오늘은 베라 베르토 주문을 배울 거란다."}]
...
execute as @s[scores={cutSceneTimer=420..500}] run title @s actionbar ["",{"text":""},{"text":"맥고나걸","color":"dark_gray"},{"text":" 그리고 특정 물체나 적을 변형시킬 수 있단다."}]
