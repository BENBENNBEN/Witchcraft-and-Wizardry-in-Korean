...
execute as @s[scores={cutSceneTimer=551..610}] run title @s actionbar ["",{"text":""},{"text":"트와이크로스","color":"dark_gray"},{"text":" 이런 식으로 말이야."}]
...
execute as @s[scores={cutSceneTimer=801..870}] run title @s actionbar ["",{"text":""},{"text":"트와이크로스","color":"dark_gray"},{"text":" 이제 네가 해봐."}]
