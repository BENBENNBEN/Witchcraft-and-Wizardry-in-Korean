...
execute as @s[scores={cutSceneTimer=161..230}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 첫 번째 수업으로는 '루모스' 마법 주문을 배워보도록 하자."}]
...
execute as @s[scores={cutSceneTimer=231..350}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 루모스는 지팡이 끝에서 빛이 나오는 마법으로 어두운 곳을 밝힐 때 쓴단다."}]
...
execute as @s[scores={cutSceneTimer=351..490}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 너무 어두워서 아무것도 볼 수 없다면"}]
...
execute as @s[scores={cutSceneTimer=491..590}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" ⌠ 를 두 번 클릭해서 루모스 마법을 시전해 보렴."}]
...
execute as @s[scores={cutSceneTimer=781..940}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 미로 같은 복도에 흩어져 있는 다섯 개의 별을 모아 오렴."}]
...
execute as @s[scores={cutSceneTimer=941..1100}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 아주 어두울 때 주문을 외워서 길을 찾는 거 잊지 말고."}]
...
execute as @s[scores={cutSceneTimer=1101..1180}] run title @s actionbar ["",{"text":""},{"text":"플리트윅","color":"dark_gray"},{"text":" 행운을 빈다!"}]
