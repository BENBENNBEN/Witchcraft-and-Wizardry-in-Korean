...
execute as @s[scores={cutSceneTimer=20..100}] run title @s actionbar ["",{"text":""},{"text":"루핀","color":"dark_gray"},{"text":" 아주 잘했어!"}]
...
execute as @s[scores={cutSceneTimer=100..240}] run title @s actionbar ["",{"text":""},{"text":"루핀","color":"dark_gray"},{"text":" 하지만 여기가 끝이 아니란다. 계속 위로 올라가렴. 정상에서 만나자."}]
