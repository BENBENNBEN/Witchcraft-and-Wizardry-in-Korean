...
execute as @s[scores={questMenu=1},tag=!preventDoubleExecution,tag=lockTrackedQuest,tag=!noQuests] run title @s subtitle {"text":"지금은 추적하는 퀘스트를 변경할 수 없습니다.","bold":false,"color":"red"}
