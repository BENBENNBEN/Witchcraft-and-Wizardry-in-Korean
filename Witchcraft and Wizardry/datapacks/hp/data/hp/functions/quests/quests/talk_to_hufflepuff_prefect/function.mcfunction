...
# Common room
##############################################
scoreboard players set @s questID 11
execute store result score @s questState run data get entity @e[tag=questHolder,limit=1] ArmorItems[3].tag."quests.talkToHufflepuffPrefect"
...
execute as @s[tag=isTrackedQuest,tag=completeTrackedQuest] run tp @s 811.59 23.00 148.67 0.79 3.11
execute as @s[tag=isTrackedQuest,tag=completeTrackedQuest] run tag @s remove completeTrackedQuest

#############
## State 1 ###########################################################################################
#############
# Speak to hufflepuff prefect
...
execute as @s[scores={questState=1},tag=isTrackedQuest] at @s as @e[tag=questDirectionTester,limit=1] positioned ~ ~ ~ run tp @s ~ ~ ~ facing 4982.5 31.00 1032.5
execute as @s[scores={questState=1,npcQuestIcon=1},tag=!inProperCutScene,tag=!inResetPoint,tag=!isFastTravelling] at @e[tag=hufflepuffPrefect,limit=1] run particle minecraft:angry_villager ~ ~2 ~ 0 0 0 100 1 force @s
...
execute as @s[tag=completeQuest,scores={playerID=1}] run scoreboard players set cedric p1convOverride 9
execute as @s[tag=completeQuest,scores={playerID=2}] run scoreboard players set cedric p2convOverride 9
execute as @s[tag=completeQuest,scores={playerID=3}] run scoreboard players set cedric p3convOverride 9
execute as @s[tag=completeQuest,scores={playerID=4}] run scoreboard players set cedric p4convOverride 9
