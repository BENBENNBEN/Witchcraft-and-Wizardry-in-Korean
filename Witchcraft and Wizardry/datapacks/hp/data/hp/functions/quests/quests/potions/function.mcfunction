...
## State 1 ###########################################################################################
#############
# Locate the Potions classroom
### Tracked Quest ###
execute as @s[scores={questState=1},tag=isTrackedQuest] run tag @s remove hideQuestTracking
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1508,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3..8,playerID=1},tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player1quest name ["",{"text":"상자에서 물약 재료를 모으기 (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" / 6)","color":"gold"}]
execute as @s[scores={questState=3..8,playerID=2},tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player2quest name ["",{"text":"상자에서 물약 재료를 모으기 (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" / 6)","color":"gold"}]
execute as @s[scores={questState=3..8,playerID=3},tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player3quest name ["",{"text":"상자에서 물약 재료를 모으기 (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" / 6)","color":"gold"}]
execute as @s[scores={questState=3..8,playerID=4},tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player4quest name ["",{"text":"상자에서 물약 재료를 모으기 (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" / 6)","color":"gold"}]
...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1507,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=9},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1505,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=10},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1506,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=10,playerID=1},tag=!inConversation,tag=inBrewer,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"머트랩 용액을 양조하기","color":"gold"}]
execute as @s[scores={questState=10,playerID=2},tag=!inConversation,tag=inBrewer,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"머트랩 용액을 양조하기","color":"gold"}]
execute as @s[scores={questState=10,playerID=3},tag=!inConversation,tag=inBrewer,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"머트랩 용액을 양조하기","color":"gold"}]
execute as @s[scores={questState=10,playerID=4},tag=!inConversation,tag=inBrewer,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"머트랩 용액을 양조하기","color":"gold"}]
...
execute as @s[scores={questState=12},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"호그와트 비밀지도\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1463,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=12,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"인벤토리를 열기","color":"gold"}]
execute as @s[scores={questState=12,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"인벤토리를 열기","color":"gold"}]
execute as @s[scores={questState=12,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"인벤토리를 열기","color":"gold"}]
execute as @s[scores={questState=12,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"인벤토리를 열기","color":"gold"}]
...
execute as @s[scores={questState=13,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"머트랩 용액을 선택하기","color":"gold"}]
execute as @s[scores={questState=13,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"머트랩 용액을 선택하기","color":"gold"}]
execute as @s[scores={questState=13,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"머트랩 용액을 선택하기","color":"gold"}]
execute as @s[scores={questState=13,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"머트랩 용액을 선택하기","color":"gold"}]
...
execute as @s[scores={questState=14,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"머트랩 용액을 퀵슬롯에 지정하기","color":"gold"}]
execute as @s[scores={questState=14,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"머트랩 용액을 퀵슬롯에 지정하기","color":"gold"}]
execute as @s[scores={questState=14,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"머트랩 용액을 퀵슬롯에 지정하기","color":"gold"}]
execute as @s[scores={questState=14,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"머트랩 용액을 퀵슬롯에 지정하기","color":"gold"}]
...
execute as @s[scores={questState=15,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"인벤토리를 닫기","color":"gold"}]
execute as @s[scores={questState=15,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"인벤토리를 닫기","color":"gold"}]
execute as @s[scores={questState=15,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"인벤토리를 닫기","color":"gold"}]
execute as @s[scores={questState=15,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"인벤토리를 닫기","color":"gold"}]
