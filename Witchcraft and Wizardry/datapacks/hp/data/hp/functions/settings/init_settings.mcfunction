...
execute as @s[scores={playerID=1}] run bossbar set minecraft:player1info name {"text":"설정","bold":true,"color":"gray"}
execute as @s[scores={playerID=2}] run bossbar set minecraft:player2info name {"text":"설정","bold":true,"color":"gray"}
execute as @s[scores={playerID=3}] run bossbar set minecraft:player3info name {"text":"설정","bold":true,"color":"gray"}
execute as @s[scores={playerID=4}] run bossbar set minecraft:player4info name {"text":"설정","bold":true,"color":"gray"}
...
execute as @s[scores={playerID=3}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initSettingsPlController","settingsPlControllerPlayer3"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,19,0,3]}
execute as @s[scores={playerID=4}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initSettingsPlController","settingsPlControllerPlayer4"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,19,0,4]}
