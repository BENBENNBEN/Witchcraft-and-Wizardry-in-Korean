...
execute store result score @s falling run data get entity 0-0-a-0-1 FallDistance 10
...
# Scroll testers
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectUp],UUID:[I;0,11,0,1]}
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectDown],UUID:[I;0,11,0,2]}
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectLeft],UUID:[I;0,11,0,3]}
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectRight],UUID:[I;0,11,0,4]}

# Scroll down
execute as @s[tag=hasChangedSlotDown,tag=!softExitMap,tag=!hasScrolled] run function hp:map/map_scroll_down
execute at 0-0-a-0-1 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!softExitMap,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=mapSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:map/map_scroll_down

# Scroll up
execute as @s[tag=hasChangedSlotUp,tag=!softExitMap,tag=!hasScrolled] run function hp:map/map_scroll_up
execute at 0-0-a-0-1 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!softExitMap,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=mapSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:map/map_scroll_up
...
execute store result score @s tmp run data get entity 0-0-a-0-1 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-a-0-1 Rotation[1] 1000
...
execute at 0-0-a-0-1 as @s[distance=0.001..,tag=!softExitMap] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!delayMapOneTick] run tp @s 0-0-a-0-1
