...
execute as @s[tag=!discovered_hagrids_hut,tag=!inProperCutScene] run function hp:map/unlock_location
scoreboard players set @s[tag=!discovered_hagrids_hut,tag=!inProperCutScene] discoverLocation 80
scoreboard players set @s[tag=discovered_hagrids_hut,tag=!inProperCutScene] discoverLocation 50
...
scoreboard players set @s lastLocation 68